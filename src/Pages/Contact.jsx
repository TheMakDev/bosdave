    ...
    <div>
      ...
      >
        <div className="flex-1">
          <p className="text-xl sm:text-2xl font-bold text-yellow-600 uppercase">Get In Touch</p>
        ...
        <div className="flex-1 bg-gray-100 p-6 sm:p-8 rounded-3xl">
          <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2 text-[#232755]">Send a message to staff</h3>
          <p className="text-sm text-gray-600 mb-6">
            Your email address will not be published. Required fields are marked <span className="text-red-500">*</span>
          </p>
          <form className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input type="text" placeholder="Your Name" className="p-4 rounded-full border border-gray-300 w-full focus:outline-none focus:ring-2 focus:ring-yellow-500" />
              <input type="email" placeholder="Your Email" className="p-4 rounded-full border border-gray-300 w-full focus:outline-none focus:ring-2 focus:ring-yellow-500" />
              <input type="tel" placeholder="Your Phone" className="p-4 rounded-full border border-gray-300 w-full focus:outline-none focus:ring-2 focus:ring-yellow-500" />
              <input type="text" placeholder="Subject" className="p-4 rounded-full border border-gray-300 w-full focus:outline-none focus:ring-2 focus:ring-yellow-500" />
            </div>
            <textarea placeholder="Message" className="w-full p-4 rounded-2xl border border-gray-300 focus:outline-none focus:ring-2 focus:ring-yellow-500" rows={5}></textarea>
      ...
      >
        <h3 className="text-2xl sm:text-3xl font-bold mb-6 text-center text-yellow-600">
          Our Location
        </h3>
