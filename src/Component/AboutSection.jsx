      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-4">
            ...
            <span className="text-red-600">Construction Services</span>
          </h2>
          ...
          <button className="bg-red-600 text-white px-6 py-2 rounded-full hover:bg-orange-600 transition duration-300">
            ABOUT US
          </button>
        </motion.div>
      </div>
