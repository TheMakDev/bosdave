    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center h-full px-4 sm:px-8 md:px-16 text-center">
          ...
          >
            We Build <span className='text-red-700'>Your Home <br /> Secure</span> And Safe
          </motion.h1>
          ...
          <motion.button
            ...
            className="bg-transparent border border-red-600 px-5 py-2 sm:px-6 sm:py-3 text-white rounded-full mt-4 sm:mt-5 font-medium text-sm sm:text-base"
          >
            Our service
          </motion.button>
        </div>
      ...
      <div className="bg-white py-10 px-4 sm:px-8 md:px-16 grid grid-cols-1 md:grid-cols-3 gap-10 -mt-16 z-20 relative shadow-lg rounded-md mx-4 sm:mx-16 text-center">
        {[
          {
            icon: <FaPencilRuler className="text-red-600 text-4xl mx-auto mb-3" />,
          ...
          {
            icon: <FaHardHat className="text-red-600 text-4xl mx-auto mb-3" />,
            title: "TEAM EFFORT",
          ...
          {
            icon: <FaTools className="text-red-600 text-4xl mx-auto mb-3" />,
